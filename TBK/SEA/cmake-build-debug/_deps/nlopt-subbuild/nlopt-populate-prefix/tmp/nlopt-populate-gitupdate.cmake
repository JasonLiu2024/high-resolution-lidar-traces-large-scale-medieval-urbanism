...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.7.0"
  WORKING_DIRECTORY "/Users/kronos.di.vlad/Desktop/SEA_folder/cmake-build-debug/_deps/nlopt-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/kronos.di.vlad/Desktop/SEA_folder/cmake-build-debug/_deps/nlopt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/kronos.di.vlad/Desktop/SEA_folder/cmake-build-debug/_deps/nlopt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
